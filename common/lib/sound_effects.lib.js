...
if ( process.env.UNIVERSAL_ENV === 'client' ) {
  ...
  // One way this lib can be used is by calling play directly on the sound.
  // eg. soundEffects.sounds.place_tile.play()
  //
  // A more flexible way is to pass in the sound name as a variable.
  // eg. soundEffects.play('place_tile')
  //
  // This line adds the syntactic sugar for this to work:
  soundEffects.play = soundName => soundEffects.sounds[soundName].play();
}
